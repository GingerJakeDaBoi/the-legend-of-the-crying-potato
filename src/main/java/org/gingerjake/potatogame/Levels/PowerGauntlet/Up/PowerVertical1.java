package org.gingerjake.potatogame.Levels.PowerGauntlet.Up;
...
public class PowerVertical1 extends GameState {
    ...
    public void draw(Graphics g) {
        ...
        if (PlayerController.y < 0) {
            if (!finished) {
                ...
                GameStateManager.setState(new PowerCurve1());
        }
